...
def generate_launch_description():
    world_gazebo_pkg_name = 'self_driving_car_pkg'
    world_gazebo_pkg_path = os.path.join(get_package_share_directory(world_gazebo_pkg_name))
    ...
    gazebo_world_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(world_gazebo_pkg_path, 'launch', 'world_gazebo.launch.py'))
    )
