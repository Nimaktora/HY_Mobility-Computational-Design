...
class Depth_Image(Node):
    def __init__(self):
        ...
        #self.turning = 0.0
        self.turning_elapsed_time = 5.5
        self.turning_pass_time = 6.0
    ...
    def status2driving(self, img):
        ...
        if len(inclinations) >= 2:
            ...
            if self.state == 'IDLE':
                ...
                cmd.linear.x = 2.5 - 2.0 * math.pow(abs(steering),3)
                ...
                #cmd.angular.z = -0.25
                cmd.angular.z = steering - kp_g * abs(math.pow((21 - self.dist_green), 3))
    ...
    def depth_callback_sync(self, rgb_msg, depth_msg):
        ...
        self.status_green = self.get_distance2status(self.dist_green, 18)
